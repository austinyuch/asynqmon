...
| [003-ui-mui4-to-mui5-migration](./003-ui-mui4-to-mui5-migration/) | Implemented(PR #7,merge 前需視覺 smoke)| SPEC-002、SPEC-004A | ui/TESTS.md | — |
| [004-ui-react16-to-react18-router6-migration](./004-ui-react16-to-react18-router6-migration/) | Implemented(A:PR #6;B:PR #8,merge 前需 smoke)| A:SPEC-002;B:SPEC-003 | SPEC-001 resolutions(path-to-regexp 已移除)、ui/TESTS.md | — |
