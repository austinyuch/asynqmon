...
| [004-ui-react16-to-react18-router6-migration](./004-ui-react16-to-react18-router6-migration/) | Completed(A:PR #6;B:PR #8;CR-2026-07-30-005)| A:SPEC-002;B:SPEC-003 | SPEC-001 resolutions(path-to-regexp 已移除)、ui/TESTS.md | — |
