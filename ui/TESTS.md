...
| UI-E2E-001 | 功能性 browser smoke(7 案例,CI gate) | `cd ui && npx playwright test e2e/smoke.spec.ts`(需 demo env,CI 自帶) | team | PR #24/#25 build.yml e2e 7/7;retry-state bounded auto-wait `3c0d1ef` | SPEC-005 Q-T1;CR-2026-07-30-002 | REQ-QG-001 |
